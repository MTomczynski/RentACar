...
namespace RentACar.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<RentACar.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(RentACar.Models.ApplicationDbContext context)
        {
            ...
            if (!context.Users.Any(t => t.UserName == "admin@mail.com"))
            {
                var user = new ApplicationUser { UserName = "admin@mail.com", Email = "admin@mail.com" };
                userManager.Create(user, "a12345");

                var service = new RentManagerService(context);
                service.CreateRentManager("admin", "user", user.Id);
